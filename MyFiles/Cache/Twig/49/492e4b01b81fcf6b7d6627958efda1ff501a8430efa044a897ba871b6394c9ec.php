...
class __TwigTemplate_099074ffd42f82aeb366d5b5d6cea68df87a196657e86a5e748d5a98db58dd58 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<form id=\"form";
    ...
    <input type=\"hidden\" name=\"multireqtoken\" value=\"";
        // line 60
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "multiRequestProtection", [], "any", false, false, false, 60), "newToken", [0 => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "user", [], "any", false, false, false, 60), "logkey", [], "any", false, false, false, 60)], "method", false, false, false, 60), "html", null, true);
        echo "\"/>
    <div class=\"";
        // line 61
...
{% endfor %}
", "Master/EditView.html.twig", "C:\\xampp2\\htdocs\\facturascripts\\facturasscripts\\Core\\View\\Master\\EditView.html.twig");
    }
}
