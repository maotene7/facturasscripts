...
class __TwigTemplate_ccd899e238d311fc75d677c17897d9a18fbbf09ef5d74c53258f4691eb0abb0a extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block bodyHeaderOptions %}
    ...
    <div class=\"container-fluid mb-1 d-print-none\">
        <div class=\"row\">
            ...
            <div class=\"col-md-5 text-right\">
                <h1 class=\"h3 d-none d-md-inline-block\">
                    {{ fsc.title }} <i class=\"{{ pageData.icon }}\" aria-hidden=\"true\"></i>
                </h1>
                <br class=\"d-md-none\"/>
            </div>
        </div>
...
{% endblock %}", "Master/ListController.html.twig", "C:\\xampp2\\htdocs\\facturascripts\\facturasscripts\\Core\\View\\Master\\ListController.html.twig");
    }
}
