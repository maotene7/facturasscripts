...
class __TwigTemplate_da12b578e70c6e4a654f36d2dab65444bed33e8cf00c8081472db5e32477abc4 extends \Twig\Template
{
    private $source;
    private $macros = [];
                ...
                {% for plugin in installedPlugins %}
                    ...
                    <tr{{ trClass | raw }}>
                        ...
                        {% if plugin.enabled %}
                            <td></td>
                            <td>
                                <a class=\"btn btn-block btn-sm btn-secondary\" href=\"{{ fsc.url() }}?action=disable&amp;plugin={{ plugin.name }}\">
                                    <i class=\"fas fa-times fa-fw\" aria-hidden=\"true\"></i>
                        ...
                        {% elseif plugin.compatible %}
                            <td>
                                {% if not constant('FS_DISABLE_RM_PLUGINS') %}
                                    <a class=\"btn btn-block btn-sm btn-danger\" href=\"#\" onclick=\"deletePlugin('{{ plugin.name }}');\">
                                        <i class=\"fas fa-trash-alt fa-fw\" aria-hidden=\"true\"></i>
                            ...
                            <td>
                                <a class=\"btn btn-block btn-sm btn-success\" href=\"{{ fsc.url() }}?action=enable&amp;plugin={{ plugin.name }}\">
                                    <i class=\"fas fa-check fa-fw\" aria-hidden=\"true\"></i>
...
{% endmacro %}", "AdminPlugins.html.twig", "C:\\xampp2\\htdocs\\facturascripts\\facturasscripts\\Core\\View\\AdminPlugins.html.twig");
    }
}
