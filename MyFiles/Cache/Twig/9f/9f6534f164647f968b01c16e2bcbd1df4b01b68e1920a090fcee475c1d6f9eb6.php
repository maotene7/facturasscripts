...
class __TwigTemplate_4751afd1358874d7ea02ca7a7b55ebb4f65c6506244fdaaa908dbed3084932a6 extends \Twig\Template
{
    private $source;
    private $macros = [];
                ...
                <tbody>
                    {% for line in firstView.model.getLines() %}
                        ...
                        <tr>
                            ...
                            <td class=\"table-warning\">
                                <input type=\"number\" name=\"refund_{{ line.primaryColumnValue() }}\" value=\"0\" min=\"0\" max=\"{{ line.cantidad - refunded }}\" step=\"any\"
                                       class=\"form-control text-right to_refund\" autocomplete=\"off\"/>
                            </td>
                        </tr>
                    {% endfor %}
...
{% endmacro %}", "Tab/RefundFacturaCliente.html.twig", "C:\\xampp2\\htdocs\\facturascripts\\facturasscripts\\Core\\View\\Tab\\RefundFacturaCliente.html.twig");
    }
}
